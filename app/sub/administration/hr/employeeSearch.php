  ...
  <div class="row" id="pageHeader" style="background-color:#F6F8F8;color:#646565;font-size:18px;">
    ...
    <div class="col-md-10 right">
      <ul id="moduleSubMenu" class="customScroll">
        <a ng-repeat="menu in moduleSubMenu" ng-click="setActiveHRView(menu.link)"><li>{{menu.title}}</li></a>
      </ul>
    </div>
  </div>
  ...
  <div class="row pad-20">
    ...
    <div class = "row">
      ...
      <div class="col-md-2 pad-10 center">
        <div>
          <!-- <div class="pad-10" style="background-color:#23b7e5;color:white;font-weight:bold;margin-bottom:10px"> Add New HR </div><hr style="margin:0px;padding:0px;"> -->
